...
Route::middleware('auth:api')->group(function () {
    ...
    Route::delete('/propiedades/{id}/valoraciones', [ValoracionController::class, 'delete']);
});
...
Route::get('/propiedades/{id}/valoraciones', [ValoracionController::class, 'filterByPropiedad']);
